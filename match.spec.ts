...
describe('match', () => {
    ...
    describe('pointWonBy', () => {
        it('should award a point to the victor', () => {
            const match = new Match('player 1', 'player 2');
            match.pointWonBy('player 1');
            expect((<any>match)._player1.points).toEqual(1);
        });
        ...
        it('should award a game to the victor', () => {
            ...
            expect((<any>match)._player1.games).toEqual(1);
        });

        it('should award a set to the victor', () => {
            const match = new Match('player 1', 'player 2');
            (<any>match)._player1.points = 3;
            (<any>match)._player1.games = 5;

            match.pointWonBy('player 1');

            expect((<any>match)._winner.name).toEqual('player 1');
        });
        ...
        it('should award a tie game to the victor', () => {
            const match = new Match('player 1', 'player 2');
            (<any>match)._player1.points = 6;
            (<any>match)._player1.games = 6;
            (<any>match)._player2.games = 6;
